...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/tencentcloudlogserviceexporter v0.38.0
...
require (
	...
	go.opentelemetry.io/collector/exporter/loggingexporter v0.69.1 // indirect
	...
	go.opentelemetry.io/collector/processor/batchprocessor v0.69.1 // indirect
